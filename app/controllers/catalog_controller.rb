class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.global_search_fields << solr_name('title', :stored_searchable, type: :string)
    config.global_search_fields << solr_name('title', :stored_searchable, type: :string)
    config.global_search_fields << solr_name('contributor', :stored_searchable, type: :string)
    config.global_search_fields << 'trans_prefLabel_ssm'
